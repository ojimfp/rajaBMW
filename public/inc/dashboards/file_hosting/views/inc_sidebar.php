...
<nav id="sidebar" aria-label="Main Navigation">
        ...
        <div class="content-header bg-white-10">
            ...
            <a class="link-fx font-w700 font-size-lg text-white" href="index.php">
                <span class="smini-visible">
                    <span class="text-white-75">F</span><span class="text-white">H</span>
                </span>
            ...
            <div>
                <!-- Extra Settings -->
                <a class="text-white-75" href="javascript:void(0)">
                    <i class="fa fa-cog"></i>
                </a>
                <!-- END Extra Settings -->
    ...
    <!-- Side Actions -->
    <div class="content-side pb-4 smini-hide">
        <a class="btn btn-hero-success btn-block" href="javascript:void(0)">
