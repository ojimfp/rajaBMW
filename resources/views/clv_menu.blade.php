    ...
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            ...
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">Average Customer Lifetime Value</li>
    ...
    <div class="row">
      <div class="col-md-6">
          <a class="block block-rounded block-link-shadow" href="clv">
              <div class="block-header block-header-default">
                  <h3 class="block-title">Average CLV</h3>
              </div>
      ...
      <div class="col-md-6">
          <a class="block block-rounded block-link-shadow" href="clv_growth">
              <div class="block-header block-header-default">
                  <h3 class="block-title">Average CLV Growth</h3>
              </div>
              <div class="block-content text-center">
      ...
      <div class="col-md-6">
          <a class="block block-rounded block-link-shadow" href="clv_loc">
              <div class="block-header block-header-default">
                  <h3 class="block-title">Average CLV by Location</h3>
              </div>
              <div class="block-content text-center">
      ...
      <div class="col-md-6">
          <a class="block block-rounded block-link-shadow" href="clv_channel">
              <div class="block-header block-header-default">
                  <h3 class="block-title">Average CLV by Channel</h3>
              </div>
              <div class="block-content text-center">
