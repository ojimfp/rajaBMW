...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Margin by Location</h1>
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">Margin</li>
                    <li class="breadcrumb-item active" aria-current="page">Margin by Location</li>
                </ol>
            </nav>
        </div>
   </div>
    ...
    <!-- Line Chart -->
            ...
            <div class="block block-bordered">
                <div class="block-content">
                    ...
                    Location with <strong>HIGHEST MARGIN</strong> in 2017 is <span style="color:#3dca60">Hawaii
                    [22,61%]</span>, followed by <span style="color:#3dca60">Alabama [21,13%]</span>, and
                    <span style="color:#3dca60">Kansas [20,82%]</span>. Green-colored location means those locations
