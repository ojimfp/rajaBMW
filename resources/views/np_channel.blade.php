...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Net Profit by Channel</h1>
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">Net Profit</li>
                    <li class="breadcrumb-item active" aria-current="page">Net Profit by Channel</li>
                </ol>
            </nav>
        </div>
   </div>
    ...
    <!-- Pie Chart -->
            ...
            <div class="block block-bordered">
                <div class="block-content">
                    ...
                    In 2017, channel with highest contribution to <strong>NET PROFIT</strong> is
                    <span style="color:#3dca60">Online [Rp 205.834.660,00]</span> channel. Among all Online channels,
                    <span style="color:#3dca60"> Tokopedia [Rp 107.875.640,00]</span> is the highest contributor to
                    <strong>NET PROFIT</strong>. Since your customers preferred online channel, your company should
