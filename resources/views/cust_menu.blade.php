...
<div class="content">
    ...
    <div class="row">
      <div class="col-md-6">
          <a class="block block-rounded block-link-shadow" href="cust_growth">
      ...
      <div class="col-md-6">
          <a class="block block-rounded block-link-shadow" href="cust_loc">
              <div class="block-header block-header-default">
      ...
      <div class="col-md-6">
          <a class="block block-rounded block-link-shadow" href="cust_category">
              <div class="block-header block-header-default">
