...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Net Profit by Location</h1>
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">Net Profit</li>
                    <li class="breadcrumb-item active" aria-current="page">Net Profit by Location</li>
                </ol>
            </nav>
        </div>
   </div>
...
<div class="content">
    ...
    <!-- Line Chart -->
            ...
            <div class="block block-bordered">
                <div class="block-content">
                    ...
                    Location with <strong>HIGHEST NET PROFIT</strong> in 2017 is <span style="color:#3dca60">Georgia
                    [Rp 57.742.160,00]</span>, followed by <span style="color:#3dca60">Illinois [Rp 45.155.500,00]</span>,
                    and <span style="color:#3dca60">Indiana [Rp 40.689.580,00]</span>. Green-colored location means those
                    locations are the high-selling locations, while the red-colored location indicates those locations
                    are having difficulties in selling products. Maintain these green-colored locations to generate
                    more sales, also, improve other low-customers locations by implementing strategies related to
                    <strong>LOCATION MARKETING</strong> on certain location such as: local marketing, customer
    ...
    <div class="row">
        <div class="col-md-6">
            <a class="block block-rounded block-link-shadow" href="np_growth">
                <div class="block-header block-header-default">
