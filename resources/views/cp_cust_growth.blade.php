...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Customer Growth</h1>
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">Customer Profitability</li>
                    <li class="breadcrumb-item active" aria-current="page">Customer Growth</li>
                </ol>
            </nav>
        </div>
   </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <a class="block block-rounded block-link-shadow" href="cs_coq">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Average Customer Order Quantity</h3>
                </div>
                <div class="block-content">
                    <img src="<?php echo $dm->assets_folder; ?>/media/photos/chart_thumbnail.png">
                </div>
