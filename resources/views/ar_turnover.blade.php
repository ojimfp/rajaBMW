...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Account Receivable Turnover Rate</h1>
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">Dashboard</li>
                    <li class="breadcrumb-item active" aria-current="page">Account Receivable Turnover Rate</li>
                </ol>
            </nav>
        </div>
   </div>
...
<div class="content">
    ...
    <h5>Improving Financial Manager (AR)</h5>
    ...
    <div class="row">
        <div class="col-md-6">
            <a class="block block-rounded block-link-shadow" href="ar_average">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Average Account Receivable</h3>
                </div>
                <div class="block-content">
